...
# ── 1. Environment setup ────────────────────────────────────────────────────
# We import our custom config file which automatically handles load_dotenv()
# and sets all necessary LangSmith/OpenAI environment variables before anything else!
import config
